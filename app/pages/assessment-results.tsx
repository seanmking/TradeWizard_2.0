...
const AssessmentResultsPage: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Your Export Readiness Results | TradeWizard</title>
        <meta 
          name="description" 
          content="View your personalized export readiness assessment results and get tailored recommendations for your business."
        />
      </Head>
          ...
          <div className={`bg-white rounded-xl shadow-md overflow-hidden ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`}>
            ...
            <div className="px-4 py-6 sm:px-10 sm:py-8">
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <p className="text-sm text-blue-800">
                          <span className="font-medium">Insight:</span> {assessmentData.export_experience?.toLowerCase().includes('yes') ? 'Your export experience gives you a strong foundation' : 'Your business could benefit from export fundamentals training'}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-8 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6">
                    ...
                    <div className={`sm:col-start-1 ${isLoaded ? 'animate-fade-in' : ''}`} style={{ animationDelay: '1.2s' }}>
                      <div className="flex items-center sm:items-end sm:flex-col">
                        ...
                        <div className="sm:text-right">
                          <h4 className="text-md font-medium text-gray-600">Detailed Analysis</h4>
                          <p className="text-xs sm:text-sm text-gray-500">Get actionable recommendations</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className={`sm:col-start-2 ${isLoaded ? 'animate-fade-in' : ''}`} style={{ animationDelay: '1.4s' }}>
                      <div className="flex items-center sm:items-start sm:flex-col">
                        ...
                        <div>
                          <h4 className="text-md font-medium text-gray-600">Export Planning</h4>
                          <p className="text-xs sm:text-sm text-gray-500">Develop your export strategy</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-10 pt-6 border-t border-gray-200 text-center">
                <p className="text-gray-600 mb-4">Ready to take the next step in your export journey?</p>
                <Link href="/register">
                  <span className="inline-block px-6 py-3 bg-blue-500 text-white font-medium rounded-lg hover:bg-blue-600 transition-colors duration-200">
